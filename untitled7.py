...
Original file is located at
    https://colab.research.google.com/drive/1PWBykasT9PN4yFKzGn3gIH8dypLulIGy
"""
...
# df['Sex'] = df['Sex'].replace('M', 'Male', regex=False)
# df['Sex'] = df['Sex'].replace('1173467', 'Male', regex=False)
# df['Admissionmonth'] = df['Admissionmonth'].replace('September', 'November', regex=False)
# df['Admissionmonth'] = df['Admissionmonth'].replace('October', 'November', regex=False)
# 
# @st.cache_resource
...
# 
# age = st.sidebar.slider("Age", min_value=0, max_value=100, value=55, step=1)
